...
public static class BookingsCreateController
{
    public static void AddEndPointBookingCreate(this WebApplication app)
    {
        ...
        booksGroup.MapPost("/create",
            ([FromServices] Dal<Models.Booking> booksDal, Dal<Schedule> schedulesDal,
                [FromBody] BooksCreateRequest booksCreateRequest) =>
            {
                try
                {
                    ...
                    var book = new Models.Booking(booksCreateRequest.clientName, booksCreateRequest.clientsPhoneNumber,
                        booksCreateRequest.schedulesId);
